            ...
            <div className="card-body">
                <form action="#" method="post">
                    <div className="form-group">
                        ...
                        <small id="emailHelp" className="form-text text-muted">We'll never share your email withanyone else.</small>
                    </div>
                    <div className="form-group">
                    ...
                    <div className="form-row">
                        ...
                        <div className="form-row">
                            ...
                            <div className="form-check check-remember check-me-out">
                                ...
                                <label className="form-check-label checkmark" for="gridCheck">Check me out</label>
                            </div>
